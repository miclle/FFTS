...
(($) ->
  ...
  $.fn.percentageLoader = (params) ->
    ...
    if (params != `undefined`) then $.extend(settings, params) else params = settings
    ...
    # Nicer to pass counterClockwise / clockwise into canvas functions than true / false
    ...
    ###
    applyAngle = (point, angle, distance) ->
    ...
    ###
      ...
      @param value the progress value, from 0 to 1. Values outside this range will be clipped
    ###
    setProgress = (value) ->
